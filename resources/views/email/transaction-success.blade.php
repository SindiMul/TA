                              ...
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#0390bb;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                  ...
                                  <tr>
                                    ...
                                    <td style="text-align: right;">{{$data->event_package->title}}</td>
                                  </tr>
                                  <tr>
                                    <td><strong>Date and Time</strong></td>
                                    <td style="text-align: right;">{{$data->departure_date}}</td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
                              ...
                              <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                  <tr>
                                    ...
                                    valign="middle">
                                    <a href="{{url ('checkout/' . $data->id) }}" style="display:inline-block;background:#0390bb;color:#ffffff;
                      ...
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            ...
                            <td style="font-size: 18px; padding-left: 10px; color: #0390bb;font-family: Assistant, Helvetica, Arial, sans-serif"> support@Digarut.id <br> 021-2019-2022 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
